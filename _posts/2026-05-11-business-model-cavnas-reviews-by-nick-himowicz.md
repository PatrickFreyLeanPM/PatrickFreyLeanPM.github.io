...
I recently stumbled upon a video by [Nick Himowicz](https://www.linkedin.com/in/nickhimo/){:target="_blank"} in which he reviewed and rated a set of business model canvases (BMC).
Nick is an expert in BMC and has worked with it for a long time (over a decade).

What is often forgotten is that the BMC is an **instrument**, not just a canvas to fill in once.
A BMC should evolve continuously, especially during the discovery phase or when something in the business model changes.

<!-- excerpt -->

<iframe width="560" height="315" src="https://www.youtube.com/embed/pE8QbxkAbDY?si=TmGnrLC5RpYQ90yY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

The video contains a set of great tips on how to make a BMC more appealing and understandable.
I have summarized Nick's tips here for quick reference:
...
1. Start with your current BMC and take a screenshot.
2. Ask an AI to review it against the checklist.
3. Apply the suggested improvements.
4. Ask for a second review of the improved version.
